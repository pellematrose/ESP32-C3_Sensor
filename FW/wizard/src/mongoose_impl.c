...
struct attribute s_mqtt_attributes[] = {
  ...
  {"broker", "string", NULL, offsetof(struct mqtt, broker), 50, false},
  {"topic_pressure", "string", NULL, offsetof(struct mqtt, topic_pressure), 30, false},
  {"topic_batvol", "string", NULL, offsetof(struct mqtt, topic_batvol), 30, false},
  {"topic_temp2", "string", NULL, offsetof(struct mqtt, topic_temp2), 30, false},
  {"topic_temp1", "string", NULL, offsetof(struct mqtt, topic_temp1), 30, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_debug_attributes[] = {
  {"boot", "bool", NULL, offsetof(struct debug, boot), 0, false},
  {"ready", "bool", NULL, offsetof(struct debug, ready), 0, false},
  {"charge", "bool", NULL, offsetof(struct debug, charge), 0, false},
  {"op", "bool", NULL, offsetof(struct debug, op), 0, false},
  {"ldo", "bool", NULL, offsetof(struct debug, ldo), 0, false},
  {"led", "bool", NULL, offsetof(struct debug, led), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_battery_attributes[] = {
  {"voltage", "int", NULL, offsetof(struct battery, voltage), 0, false},
  {"percent", "int", NULL, offsetof(struct battery, percent), 0, false},
  {"status", "string", NULL, offsetof(struct battery, status), 10, false},
  {NULL, NULL, NULL, 0, 0, false}
};
...
struct attribute s_calibration_attributes[] = {
  {"tempcal2", "double", "%.2f", offsetof(struct calibration, tempcal2), 0, false},
  {"tempcal1", "double", "%.2f", offsetof(struct calibration, tempcal1), 0, false},
  {"ench2", "bool", NULL, offsetof(struct calibration, ench2), 0, false},
  {"ench1", "bool", NULL, offsetof(struct calibration, ench1), 0, false},
  {"adcl2", "int", NULL, offsetof(struct calibration, adcl2), 0, false},
  {"adch2", "int", NULL, offsetof(struct calibration, adch2), 0, false},
  {"adc2", "int", NULL, offsetof(struct calibration, adc2), 0, false},
  {"adcl", "int", NULL, offsetof(struct calibration, adcl), 0, false},
  {"adch", "int", NULL, offsetof(struct calibration, adch), 0, false},
  {"adc", "int", NULL, offsetof(struct calibration, adc), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_wifi_attributes[] = {
  {"ssid", "string", NULL, offsetof(struct wifi, ssid), 25, false},
  {"password", "string", NULL, offsetof(struct wifi, password), 25, false},
  {"save", "bool", NULL, offsetof(struct wifi, save), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
...
struct apihandler_action s_apihandler_tempoffset2 = {{"tempoffset2", "action", false, 0, 0, 0UL}, glue_check_tempoffset2, glue_start_tempoffset2};
struct apihandler_action s_apihandler_tempoffset1 = {{"tempoffset1", "action", false, 0, 0, 0UL}, glue_check_tempoffset1, glue_start_tempoffset1};
...
struct apihandler_action s_apihandler_resetcal2 = {{"resetcal2", "action", false, 0, 0, 0UL}, glue_check_resetcal2, glue_start_resetcal2};
struct apihandler_action s_apihandler_resetcal1 = {{"resetcal1", "action", false, 0, 0, 0UL}, glue_check_resetcal1, glue_start_resetcal1};
struct apihandler_action s_apihandler_btnlow2 = {{"btnlow2", "action", false, 0, 0, 0UL}, glue_check_btnlow2, glue_start_btnlow2};
struct apihandler_action s_apihandler_btnhigh2 = {{"btnhigh2", "action", false, 0, 0, 0UL}, glue_check_btnhigh2, glue_start_btnhigh2};
struct apihandler_action s_apihandler_btnhigh = {{"btnhigh", "action", false, 0, 0, 0UL}, glue_check_btnhigh, glue_start_btnhigh};
struct apihandler_action s_apihandler_btnlow = {{"btnlow", "action", false, 0, 0, 0UL}, glue_check_btnlow, glue_start_btnlow};
struct apihandler_data s_apihandler_temperature = {{"temperature", "data", false, 0, 0, 0UL}, s_temperature_attributes, sizeof(struct temperature), (void (*)(void *)) glue_get_temperature, (void (*)(void *)) glue_set_temperature};
struct apihandler_data s_apihandler_calibration = {{"calibration", "data", false, 0, 0, 0UL}, s_calibration_attributes, sizeof(struct calibration), (void (*)(void *)) glue_get_calibration, (void (*)(void *)) glue_set_calibration};
...
static struct apihandler *s_apihandlers[] = {
  ...
  (struct apihandler *) &s_apihandler_tempoffset2,
  (struct apihandler *) &s_apihandler_tempoffset1,
  (struct apihandler *) &s_apihandler_battery,
  (struct apihandler *) &s_apihandler_resetcal2,
  (struct apihandler *) &s_apihandler_resetcal1,
  (struct apihandler *) &s_apihandler_btnlow2,
  (struct apihandler *) &s_apihandler_btnhigh2,
  (struct apihandler *) &s_apihandler_btnhigh,
  (struct apihandler *) &s_apihandler_btnlow,
  (struct apihandler *) &s_apihandler_temperature,
  (struct apihandler *) &s_apihandler_calibration,
